...
def addChannels2XML(xmltv, bouquets_services, epg, api_root_url, continuous_numbering, icon_url):
    """
...
def generateXMLTV(bouquets_services, epg, api_root_url, tzoffset,
        continuous_numbering, icon_url, category_override):
    """
    ...
    xmltv = addChannels2XML(xmltv, bouquets_services, epg, api_root_url, continuous_numbering, icon_url)
...
def main(bouquet=None, username=None, password=None, host='localhost', port=80,
    output_file='epg.xmltv', continuous_numbering=False, icon_url=None, list_bouquets=False,
    ...
    xmltv = generateXMLTV(
        bouquets_services, epg, api_root_url, tzoffset, continuous_numbering, icon_url,
        category_override)
